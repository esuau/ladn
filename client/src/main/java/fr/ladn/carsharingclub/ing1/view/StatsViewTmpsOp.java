...
public class StatsViewTmpsOp extends JPanel {
	...
	public StatsViewTmpsOp(Client client) {
        this.client = client;
			...
			txtpnNombreDoprations.setText("Durée moyenne d'opérations");
			...
			txtpnSiVous.setText("- Si vous ne sélectionner pas de dates, par défaut, c'est la durée moyenne d'opérations par semaine depuis le début de l'année qui sera affiché -");
