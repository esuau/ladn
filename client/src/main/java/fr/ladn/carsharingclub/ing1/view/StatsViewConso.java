...
public class StatsViewConso extends JPanel {
	...
	public StatsViewConso(Client client) {
        this.client = client;
		...
		txtpnNombreDoprations.setText("Nombre de pièces consommées sur une période");
		...
		txtpnSiVous.setText("- Si vous ne sélectionner pas de dates, par défaut, c'est le nombre de pièces consommées par semaine depuis le début de l'année qui sera affiché -");
